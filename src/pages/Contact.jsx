            ...
            <section className="contact-section">
                <div className="container">
                    <div className="d-none d-sm-block mb-5 pb-4">
                        ...
                        {/* Note: Google Maps script should be loaded in index.html or via a library */}
                    </div>
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <div className="form-group">
                                            <textarea className="form-control w-100" name="message" id="message" cols="30" rows="9" onFocus={(e) => e.target.placeholder = ''} onBlur={(e) => e.target.placeholder = 'Enter Message'} placeholder=" Name"></textarea>
                                        </div>
                                    </div>
